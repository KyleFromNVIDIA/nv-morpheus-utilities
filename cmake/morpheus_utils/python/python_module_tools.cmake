...
macro(__create_python_library MODULE_NAME)
  ...
  if(_ARGS_BUILD_STUBS)
    ...
    add_custom_command(
      ...
      COMMAND env LD_LIBRARY_PATH=${module_root_binary_dir}:$LD_LIBRARY_PATH PYTHONPATH=${module_root_binary_dir}:$PYTHONPATH ${Python3_EXECUTABLE} -m pybind11_stubgen ${TARGET_NAME} --no-setup-py --log-level WARN -o ./ --root-module-suffix ""
